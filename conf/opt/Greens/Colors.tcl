...
Classy::configcolor {Basic colors} {
	Background *Background #66ce7a {Default background color}
	{Dark backgound} *darkBackground #53a863 {Default dark background color}
	{Light backgound} *lightBackground Background {Default dark background color}
	Foreground *Foreground black {Default foreground color}
	{Active background} *activeBackground Background {Default active background color}
	...
	{Selection background} *selectBackground black {Default Selection background color}
	{Selection foreground} *selectForeground Background {Default Selection foreground color}
	{Select color} *selectColor darkgreen {Default Select color}
