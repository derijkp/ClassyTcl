...
Classy::configcolor {Basic colors} {
	Background *Background #9090f0 {Default background color}
	{Dark backgound} *darkBackground #8080d0 {Default dark background color}
	...
	{Selection foreground} *selectForeground white {Default Selection foreground color}
