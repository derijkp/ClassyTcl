...
Classy::configcolor {Basic colors} {
	Background *Background #efe6dc {Default background color}
	{Dark backgound} *darkBackground #e2d9d0 {Default dark background color}
	...
	{Selection background} *selectBackground #799096 {Default Selection background color}
	{Selection foreground} *selectForeground black {Default Selection foreground color}
	{Select color} *selectColor #ad2a47 {Default Select color}
