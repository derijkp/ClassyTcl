...
option add *Background #efe6dc widgetDefault
## {Dark backgound} {Default dark background color} color
option add *DarkBackground #e2d9d0 widgetDefault
...
option add *disabledForeground gray55 widgetDefault
## {Selection background} {Default Selection background color} color
option add *selectBackground #799096 widgetDefault
...
option add *selectColor #ad2a47 widgetDefault
## {Highlight background} {Default Highlight background color} color
option add *HighlightBackground #efe6dc widgetDefault
...
option add *Entry.background #c1ae9e widgetDefault
## {Text background} {Text background color} color
option add *Text.background #efe6dc widgetDefault
## {Listbox background} {Listbox background color} color
option add *Listbox.background #e2d9d0 widgetDefault
...
option add *Scale.activeForeground #efe6dc widgetDefault
## {Scale background} {Scale background color} color
option add *Scale.background #efe6dc widgetDefault
## {Scale slider foreground} {Scale slider foreground color} color
option add *Scale.sliderForeground #efe6dc widgetDefault
## {Scale slider background} {Scale slider background color} color
option add *Scale.sliderBackground #e2d9d0 widgetDefault
## {Scrollbar foreground} {Scrollbar foreground color} color
option add *Scrollbar.foreground #efe6dc widgetDefault
## {Scrollbar active foreground} {Scrollbar active foreground color} color
option add *Scrollbar.activeForeground #efe6dc widgetDefault
## {Scrollbar background} {Scrollbar background color} color
option add *Scrollbar.background #e2d9d0 widgetDefault
## {Label background} {Label background color} color
option add *Label.background #e2d9d0 widgetDefault
## {label background} {label background color} color
option add *label.background #e2d9d0 widgetDefault
