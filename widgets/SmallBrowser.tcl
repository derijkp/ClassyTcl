...
# Classy::SmallBrowser
# ----------------------------------------------------------------------
#doc SmallBrowser title {
#SmallBrowser
#} descr {
#}
#doc {SmallBrowser options} h2 {
#	SmallBrowser specific options
#}
#doc {SmallBrowser command} h2 {
#	SmallBrowser specific methods
#}
# Next is to get the attention of auto_mkindex
if 0 {
proc ::Classy::SmallBrowser {} {}
proc SmallBrowser {} {}
}
...
Widget subclass Classy::SmallBrowser
Classy::export SmallBrowser {}

bind Classy::SmallBrowser <Configure> {%W redraw}
Classy::SmallBrowser classmethod init {args} {
	# REM Create object
	# -----------------
	super
...
Classy::SmallBrowser chainoptions {$object.c}

Classy::SmallBrowser addoption -minx {minX MinX 50} {
	Classy::todo $object redraw
}

Classy::SmallBrowser addoption -miny {minY MinY 50} {
	Classy::todo $object redraw
}

Classy::SmallBrowser addoption -padx {padX PadX 4} {
	Classy::todo $object redraw
}

Classy::SmallBrowser addoption -pady {padY PadY 4} {
	Classy::todo $object redraw
}

Classy::SmallBrowser addoption -padtext {padText PadText 4} {
	Classy::todo $object redraw
}

Classy::SmallBrowser addoption -font {font Font {}} {
	if {"$value" == ""} {
...
Classy::SmallBrowser addoption -datafont {dataFont Font {}} {
	if {"$value" == ""} {
		set value [option get $object.c font Font]
	}
	Classy::todo $object redraw
...
Classy::SmallBrowser addoption -data {data Data {}} {
	Classy::todo $object redraw
}

Classy::SmallBrowser addoption -dataunder {dataUnder DataUnder 0} {
	set value [true $value]
	Classy::todo $object redraw
}

Classy::SmallBrowser addoption -order {order Order row} {
	switch $value {
		column {
...
Classy::SmallBrowser chainallmethods {$object.c} canvas

Classy::SmallBrowser method add {name args} {
...
Classy::SmallBrowser method redraw {} {
	private $object data options
...
Classy::SmallBrowser method _drawdataunder {nx ny name id} {
	private $object data options
	set padx $options(-padx)
	set pady $options(-pady)
	set padtext $options(-padtext)
...
Classy::SmallBrowser method _drawdata {nx names items} {
	private $object data options
	set padx $options(-padx)
	set pady $options(-pady)
	set padtext $options(-padtext)
...
Classy::SmallBrowser method clear {} {
	private $object data options
	$object.c delete all
	unset data
	set data() {}
...
Classy::SmallBrowser method name {index {y {}}} {
	if {"$y" != ""} {
...
Classy::SmallBrowser method type {index {y {}}} {
	if {"$y" != ""} {
		set index [$object.c find overlapping $index $y $index $y]
	}
	set tags [$object itemcget $index -tags]
