...
Classy::Dialog subclass ::Classy::LineChartBox
Classy::export LineChartBox {}

::Classy::LineChartBox classmethod init {args} {
	super -resize {1 1}
...
::Classy::LineChartBox component canvas {$object.options.canvas}
::Classy::LineChartBox component chart {$object.options.chart}
::Classy::LineChartBox component grid {$object.options.grid}
...
#	set elements "[$chart ranges] [array names data]"
	foreach element [$chart ranges] {
		...
		Classy::NumEntry $w.width$num -label "Line width" -width 5 \
			-command "$chart lineconfigure [list $element] -width \[$w.width$num get\]"
...
::Classy::LineChartBox method _setscroll {args} {
	private $object options
